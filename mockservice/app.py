...
from schemas import BaggageSelectionsRequest
...
@app.get('/orders')
async def orders(reservationId: str, passengerName: str):
    return orders_data


@app.put('/bags')
async def add_ski_to_shopping_cart(request: BaggageSelectionsRequest):
    return {
        'shoppingCart': request.dict()
    }